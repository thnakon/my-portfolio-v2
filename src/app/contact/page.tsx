...
export default function ContactPage() {
  ...
  return (
    <div className="relative w-full min-h-screen sm:h-screen overflow-hidden bg-white text-black flex flex-col items-center justify-center p-4 sm:p-8 selection:bg-black selection:text-white">
